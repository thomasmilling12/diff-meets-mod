...
const command: Command = {
  data: new ContextMenuCommandBuilder()
    ...
    .setDefaultMemberPermissions(PermissionFlagsBits.ModerateMembers) as unknown as import("discord.js").SlashCommandBuilder,

  async execute(interaction: UserContextMenuCommandInteraction) {
    const modal = new ModalBuilder()
      .setCustomId(`quickwarn_${interaction.targetId}`)
      .setTitle(`Warn ${interaction.targetUser.tag}`);
